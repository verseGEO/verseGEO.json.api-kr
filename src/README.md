...
|-----|---|---|--------|---------|-|
|merchantInformation.merchantId|Y|50|채널번호|MW30P에서 할당된 채널 번호|0000000000013|
|merchantInformation.merchantSiteId|Y|30|채널하위번호|MW30P에서 할당된 하위채널 번호|000001|
|clientReferenceInformation.code|Y|20|거래번호|채널에서 생성하는 거래 유일값 (ex) System ID or Server ID+yyyMMdd+hhmmss+milisecond)|20220316192601001|
